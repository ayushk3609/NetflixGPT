...
const MovieInfo = ({ video, detail }) => {
    ...
    const text = "https://www.youtube.com/watch?v=" + video
    const votes = Math.ceil(detail?.rating * 10)
        ...
        (!detail) ? <Shimmer /> :
            <div className=''>
                ...
                <div className='flex justify-between'>
                    ...
                    {video &&  <CopyToClipboard text={text} onCopy={handleCopy}><button className='text-slate-400 text-[13px] md:text-xl px-2 cursor-pointer'><i className="fa-regular fa-share-from-square"></i></button></CopyToClipboard>}
