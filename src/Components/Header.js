  ...
  return (
    <>
      <div className='absolute px-8 py-2 bg-gradient-to-b from-black w-screen flex justify-between z-10 '>
        ...
        {user &&
          <div className='flex'>
            <button className='px-4 my-5 bg-purple-800 text-sm text-white rounded mx-4'
              onClick={handleGPTSearchClick}
            >GPT search</button>
            <div onMouseEnter={handleDropdownOpen} onMouseLeave={handleDropdownClose} className='flex my-5 profile'>
